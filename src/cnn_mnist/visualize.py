...
def visualize(model_checkpoint: str = "model.pt", figure_name: str = "embeddings.png") -> None:
    """Visualize model predictions."""
    model = MyAwesomeModel()
    model.load_state_dict(torch.load(f"models/{model_checkpoint}", weights_only=True))
    model.eval()
